 ...
 * @txt: MAC address as a colon-separated hexadecimal string
 ...
 * A(6):B(6):C(2):D(1):-:-:-:-:-:-:-:-:E(1):-:-:F(4):G(4):H(2):I(2)
 *
 ...
 * E: IP protocol
 * F: IPv4 source address (four octets)
 * G: IPv4 destination address (four octets)
