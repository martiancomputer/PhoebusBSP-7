...
/* Phoebus: per-RF-front-end power-gain table, imported from the AX10v3 GPL.
 * This driver was staged from rtl8198d-sdk-main, a different board's SDK, which
 * never carried the _type variants -- so with CONFIG_SLOT_0_RFE_TYPE_3 we were
 * loading the generic PHY_REG_PG_8192F table regardless of the front end. */
...
#else
extern u1Byte *data_TxPowerTrack_AP_8192F_start,    *data_TxPowerTrack_AP_8192F_end;
#endif

#ifdef TXPWR_LMT_92FE
extern unsigned char *data_TXPWR_LMT_92FE_new_start, *data_TXPWR_LMT_92FE_new_end;
/* Phoebus: matching per-front-end TX power limit table (see PG note above). */
