...
/* Phoebus: per-front-end tables imported from the AX10v3 GPL; this driver
 * came from rtl8198d-sdk-main and never had the _type variants. */
...
#else
#include "../../../data_TxPowerTrack_AP_8192F.c"
#endif
...
#else
VAR_MAPPING(TxPowerTrack_AP_8192F, TxPowerTrack_AP_8192F);
#endif
